...
#define FFMPEG_CONFIGURATION "--prefix=/__w/foundation-build-deps/foundation-build-deps/build/FFmpeg --pkg-config=/usr/bin/pkg-config --extra-cflags=' -w' --extra-cxxflags=' -w' --cc=/usr/bin/cc --cxx=/usr/bin/c++ --ar=/usr/bin/ar --ranlib=/usr/bin/ranlib --pkg-config-flags=--static --extra-cflags=-I/__w/foundation-build-deps/foundation-build-deps/build/usr/local/include --extra-cflags=-I/__w/foundation-build-deps/foundation-build-deps/build/x264/include --extra-cflags=-I/__w/foundation-build-deps/foundation-build-deps/build/libva/include --extra-cflags=-I/__w/foundation-build-deps/foundation-build-deps/build/vulkan/include --extra-ldflags=-L/__w/foundation-build-deps/foundation-build-deps/build/usr/local/lib --extra-ldflags=-L/__w/foundation-build-deps/foundation-build-deps/build/x264/lib --extra-ldflags=-L/__w/foundation-build-deps/foundation-build-deps/build/libva/lib --extra-ldflags=-L/__w/foundation-build-deps/foundation-build-deps/build/vulkan/lib --extra-libs='-lpthread -lm' --disable-all --disable-autodetect --disable-iconv --enable-gpl --enable-static --enable-avcodec --enable-avutil --enable-bsfs --enable-swscale --enable-encoder='ac3,eac3,mpeg2video,h263p' --enable-cuda --enable-encoder='h264_nvenc,hevc_nvenc,av1_nvenc' --enable-ffnvcodec --enable-nvenc --enable-libsvtav1 --enable-encoder=libsvtav1 --enable-vaapi --enable-encoder='h264_vaapi,hevc_vaapi,av1_vaapi,mpeg2_vaapi' --enable-vulkan --enable-encoder='h264_vulkan,hevc_vulkan,av1_vulkan' --enable-libx264 --enable-encoder=libx264 --enable-libx265 --enable-encoder=libx265 --enable-encoder=h264_v4l2m2m --enable-v4l2_m2m"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/__w/foundation-build-deps/foundation-build-deps/build/FFmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/__w/foundation-build-deps/foundation-build-deps/build/FFmpeg/share/ffmpeg"
#define CC_IDENT "gcc 14.2.0 (Alpine 14.2.0)"
