...
#define FFMPEG_CONFIGURATION "--prefix=/d/a/foundation-build-deps/foundation-build-deps/build/FFmpeg --pkg-config=/d/a/_temp/msys64/usr/bin/pkg-config.exe --extra-cflags=' -w' --extra-cxxflags=' -w' --cc='D:/a/_temp/msys64/ucrt64/bin/cc.exe' --cxx='D:/a/_temp/msys64/ucrt64/bin/c++.exe' --ar='D:/a/_temp/msys64/ucrt64/bin/ar.exe' --ranlib='D:/a/_temp/msys64/ucrt64/bin/ranlib.exe' --pkg-config-flags=--static --extra-cflags=-I/d/a/foundation-build-deps/foundation-build-deps/build/usr/local/include --extra-cflags=-I/d/a/foundation-build-deps/foundation-build-deps/build/x264/include --extra-cflags=-I/d/a/foundation-build-deps/foundation-build-deps/build/libva/include --extra-cflags=-I/d/a/foundation-build-deps/foundation-build-deps/build/vulkan/include --extra-ldflags=-L/d/a/foundation-build-deps/foundation-build-deps/build/usr/local/lib --extra-ldflags=-L/d/a/foundation-build-deps/foundation-build-deps/build/x264/lib --extra-ldflags=-L/d/a/foundation-build-deps/foundation-build-deps/build/libva/lib --extra-ldflags=-L/d/a/foundation-build-deps/foundation-build-deps/build/vulkan/lib --extra-libs='-lpthread -lm' --disable-all --disable-autodetect --disable-iconv --enable-gpl --enable-static --enable-avcodec --enable-avutil --enable-bsfs --enable-swscale --enable-encoder='ac3,eac3,mpeg2video,h263p' --enable-encoder='h264_mf,hevc_mf,av1_mf' --enable-mediafoundation --enable-cuda --enable-encoder='h264_nvenc,hevc_nvenc,av1_nvenc' --enable-ffnvcodec --enable-nvenc --enable-libsvtav1 --enable-encoder=libsvtav1 --enable-libx264 --enable-encoder=libx264 --enable-libx265 --enable-encoder=libx265 --enable-d3d11va --enable-encoder='h264_qsv,hevc_qsv,av1_qsv,mpeg2_qsv' --enable-libvpl"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/d/a/foundation-build-deps/foundation-build-deps/build/FFmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/d/a/foundation-build-deps/foundation-build-deps/build/FFmpeg/share/ffmpeg"
#define CC_IDENT "gcc 16.1.0 (Rev5, Built by MSYS2 project)"
